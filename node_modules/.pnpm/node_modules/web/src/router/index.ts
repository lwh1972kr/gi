...
// 1️⃣ 모든 모듈의 routes.ts 자동 import
const modules = import.meta.glob("~packages/**/routes.ts", { eager: true }) as Record<
  string,
...
const dynamicRoutes: RouteRecordRaw[] = Object.values(modules).flatMap((mod) =>
